/*
This program extends the previous problem (problem 8).
This program adds the ability to decide to calcualte another volume or to quit after
calculating one volume
 */
package Chapter3;
...
public class Nine {
    public static void main(String[] args) {
        ...
        //Chose to use a do-while loop so that we can continue to calculate volumes
        //unless the user chooses the input that matches our sentinel value
        do {
            ...
            System.out.println("Do you wish to calculate another volume?");
            System.out.println("Type y to calculate a volume or n to quit.");
            continuing = keyboard.nextLine();

        } while (!continuing.equals(SENTINEL));
    }
}
